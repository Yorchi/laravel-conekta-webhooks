...
namespace Yorchi\LaravelConektaWebhooks\Exceptions;
...
class WebhookFailed extends Exception
{
    ...
    public static function jobClassDoesNotExist($jobClass, $conektaWebhookCall)
    {
        return new static("The job class `{$jobClass}` dosent exists.");
    }
